...
<html lang="pt-br">
  ...
  <body>
        ...
        <div class="container">
            ...
            <h4 class="my-4">{{$livro}}</h4>
            <div class="row mb-4">
                @foreach($verses as $verso)
                    <div class="col-lg-1 col-md-2 col-sm-4 col-1">
                        <a href="{{ route('verse', [$verso->chapter, $verso->book, $livro]) }}" class="text-decoration-none">
                            <div class="box bg-primary p-2 mb-1 text-white rounded text-center">
                                {{$verso->chapter}}
                            </div>
                        </a>
                    </div>
